...
namespace OdevPersonelGorev
{
    class Db_Employee
    {
        ...
        public List<Employee> Get_EmployeeList()
        {
            ...
            SqlCommand com = new SqlCommand("Select_Employees", con);
        ...
        {
            SqlCommand com_select_employee = new SqlCommand("Select_EmployeeTasks",con);
            com_select_employee.CommandType = System.Data.CommandType.StoredProcedure;
            com_select_employee.Parameters.AddWithValue("@EmployeeID", employeeId);
            OpenConnection();
